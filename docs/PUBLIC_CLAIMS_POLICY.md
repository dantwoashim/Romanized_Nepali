...
These are allowed when current checks pass:

- local-first prototype
- privacy-first browser/PWA
...
- Locked probe set.
- Manual competitor outputs collected legally.
- Real-user consented document protocol populated.
