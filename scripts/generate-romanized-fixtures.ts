...
function generateRegressions(seedEntries: SeedEntry[]): Fixture[] {
  const handPicked: Fixture[] = [
    ...
    { category: "regression:government", input: "jilla prashasan karyalaya", expected: "जिल्ला प्रशासन कार्यालय" },
    { category: "regression:government", input: "rastriya parichayapatra", expected: "राष्ट्रिय परिचयपत्र" },
    { category: "regression:government", input: "rastriya parichaypatra", expected: "राष्ट्रिय परिचयपत्र" },
    { category: "regression:education", input: "shiksha mantralaya", expected: "शिक्षा मन्त्रालय" },
    ...
    { category: "regression:names", input: "laxmi", expected: "लक्ष्मी" },
    { category: "regression:names", input: "laxmee", expected: "लक्ष्मी" },
    { category: "regression:names", input: "neeraj bhushal", expected: "नीरज भुसाल" },
    ...
    { category: "regression:names", input: "shreshtha", expected: "श्रेष्ठ" },
    { category: "regression:title-case", input: "Sarkar", expected: "सरकार" },
    { category: "regression:title-case", input: "Shastra", expected: "शास्त्र" },
    { category: "regression:title-case", input: "Thapa", expected: "थापा" },
    { category: "regression:title-case", input: "Tika", expected: "टीका" },
    { category: "regression:title-case", input: "Laxmi", expected: "लक्ष्मी" },
